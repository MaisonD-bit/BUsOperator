    ...
    public function apiIndex()
    {
        try {
            $routes = BusRoute::where('status', 'active')
                ->with(['stops']) // Include stops data
                // Include geometry so mobile clients can draw the route
                ->select('id', 'name', 'code', 'start_location', 'end_location', 'regular_price', 'aircon_price', 'distance_km', 'geometry')
                ->orderBy('name')
                ->get();
    ...
    public function apiShow($id)
    {
        try {
            $route = BusRoute::where('status', 'active')
                ->with(['stops'])
                // Include geometry so mobile clients can request full route details including path
                ->select('id', 'name', 'code', 'start_location', 'end_location', 'description', 'regular_price', 'aircon_price', 'distance_km', 'estimated_duration', 'geometry')
                ->findOrFail($id);
