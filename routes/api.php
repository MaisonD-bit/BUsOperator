...
Route::group(['middleware' => 'api'], function () {
    ...
    // Payment endpoints
    Route::post('payments/maya/create', [\App\Http\Controllers\PaymentController::class, 'createMayaCheckout']);
    Route::get('payments/maya/verify/{id}', [\App\Http\Controllers\PaymentController::class, 'verifyMayaPayment']);
    Route::post('payments/maya/webhook', [\App\Http\Controllers\PaymentController::class, 'handleWebhook']);
});
