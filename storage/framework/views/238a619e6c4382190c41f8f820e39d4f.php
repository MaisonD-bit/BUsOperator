            ...
            <div class="card shadow-sm">
                <div class="card-body py-2">
                    <div class="d-flex justify-content-center align-items-center flex-wrap gap-2">
                        ...
                        <input type="date" id="terminal-date" class="form-control form-control-sm" style="width: auto;" value="<?php echo e(date('Y-m-d')); ?>" min="<?php echo e(date('Y-m-d')); ?>">
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select form-select-sm" id="assign_route_id" name="route_id" required disabled>
                                ...
                                <?php $__currentLoopData = $routes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $route): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($route->id); ?>"><?php echo e($route->code); ?> - <?php echo e($route->start_location); ?> → <?php echo e($route->end_location); ?></option>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select form-select-sm" id="assign_driver_id" name="driver_id" required disabled>
                                ...
                                <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($driver->id); ?>"><?php echo e($driver->name); ?> (<?php echo e($driver->license_number ?? 'N/A'); ?>)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-select form-select-sm" id="assign_bus_id" name="bus_id" required disabled>
                                ...
                                <?php $__currentLoopData = $buses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($bus->id); ?>"><?php echo e($bus->plate_number); ?> (<?php echo e($bus->capacity); ?> seats)</option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('<?php echo e(asset("svg/CSBT_layout.svg")); ?>')
    ...
    assignForm.addEventListener('submit', function(e) {
        ...
        fetch('<?php echo e(route("terminal.assign-space")); ?>', {
            method: 'POST',
            headers: {
    ...
    function loadAssignments() {
        ...
        fetch(`<?php echo e(route('terminal.get-assignments')); ?>?date=${selectedDate}`)
            .then(response => response.json())
            .then(data => {
    ...
    window.removeAssignment = function(assignmentId) {
        if (confirm('Remove this assignment?')) {
            fetch(`<?php echo e(route('terminal.remove-assignment')); ?>`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                    'Content-Type': 'application/json'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\kylecb\Desktop\Capstone\Testing\BUsOperator\resources\views/panels/terminal.blade.php ENDPATH**/ ?>