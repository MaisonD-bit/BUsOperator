<div class="sidebar">
    ...
    <div class="nav-links">
        ...
        <a href="<?php echo e(route('chat.panel')); ?>" class="nav-item <?php echo e(request()->routeIs('chat.*') ? 'active' : ''); ?>">
...
</script><?php /**PATH C:\Users\kylecb\Desktop\Capstone\Testing\BUsOperator\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>