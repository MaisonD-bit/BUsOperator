    ...
    <div class="register-container">
        ...
        <form method="POST" action="<?php echo e(route('register.post')); ?>" enctype="multipart/form-data"> <!-- Updated route name -->
            ...
            <div class="photo-upload-section">
                ...
                <small class="text-muted d-block mt-2">Allowed formats: JPG, JPEG, PNG. Max size: 2MB</small>
            </div>
...
</html><?php /**PATH C:\Users\User\Desktop\TransiTrack System\BusOperator\resources\views/register.blade.php ENDPATH**/ ?>